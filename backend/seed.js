...
const seed = async () => {
  try {
    ...
    const products = await Product.create([
      { name: 'Fresh Tomatoes',      price: 120, unit: 'kg',     quantity: 50,  category: 'Vegetables', farmer: farmers[0]._id, phone: '+254712345678', location: 'Nyeri',    description: 'Sun-ripened tomatoes grown organically on the fertile slopes of Mt. Kenya. Rich in lycopene and bursting with natural flavor.', isAvailable: true },
      ...
      { name: 'Milk (Fresh)',        price: 60,  unit: 'litre',  quantity: 100, category: 'Dairy',      farmer: farmers[3]._id, phone: '+254745678901', location: 'Kisumu',   description: 'Fresh whole milk from grass-fed cows. No preservatives. Collected twice daily.', isAvailable: true },
    ])
