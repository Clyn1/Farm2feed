...
export default function Navbar() {
  ...
  const dashboardPath =
    isLoggedIn ? (user.role === 'farmer' ? '/dashboard/farmer' : '/dashboard/consumer') : '/login'
        ...
        <div className="hidden md:flex items-center gap-3">
          {isLoggedIn ? (
            <div className="flex items-center gap-3">
              ...
              <button onClick={handleLogout} className="btn-ghost text-red-500 hover:text-red-700 hover:bg-red-50 text-sm">
                Logout
              </button>
            </div>
          ) : (
